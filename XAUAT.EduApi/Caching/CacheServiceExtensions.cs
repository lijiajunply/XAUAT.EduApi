...
public static class CacheServiceExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddCacheServices()
        {
            // 注册缓存配置选项
        ...
        /// <returns>服务集合</returns>
        public IServiceCollection AddCacheServices(Action<CacheOptions> configureOptions)
        {
            // 注册缓存配置选项
            services.AddOptions<CacheOptions>()
        ...
        /// <returns>服务集合</returns>
        public IServiceCollection AddCacheServices(string sectionName)
        {
            // 从配置中绑定缓存选项
        ...
        /// <param name="sectionName">配置节名称</param>
        /// <returns>服务集合</returns>
        public IServiceCollection AddCacheServices(IConfiguration configuration, string sectionName = "Cache")
        {
            // 从配置中绑定缓存选项
